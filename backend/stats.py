...
class StatsMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request, response):
        ...
        logger.debug("Took: {}ms {} {} {}{} {}".format(int(duration * 1000), request.META.get('REMOTE_ADDR'), request.method, request.path, "?"+request.META.get('QUERY_STRING') if request.META.get('QUERY_STRING') else '', request.body))
