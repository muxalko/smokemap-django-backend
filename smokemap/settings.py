...
# try to detect vercel environment
    ...
    CORS_ALLOWED_ORIGINS = [
        ...
        "https://smokemap-staging.vercel.app",
    ...
    #     r"^https://smokemap-webapp-\w+\.vercel\.app$"
    # ]
...
MEDIA_STORAGE_INTERNAL_ENDPOINT_URL = os.environ.get(
    "MEDIA_STORAGE_INTERNAL_ENDPOINT_URL", AWS_S3_ENDPOINT_URL
)
MEDIA_UPLOAD_ENDPOINT_URL = os.environ.get(
    "MEDIA_UPLOAD_ENDPOINT_URL", AWS_S3_ENDPOINT_URL
)
